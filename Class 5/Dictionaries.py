...
test[2] = test.get(2) + [1]
print("Dictionary after using get: ", test, "\n")
...
test.popitem()
print("After removing the first item in the dictionary: ", test)
...
test[(10, 20)] = {1: 2, 4: 3}
print("After adding new elements: ", test)

#NOTE:Dictionary keys always have to be immutable, that is it can only be a string, number or a tuple